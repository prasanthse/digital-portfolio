...
1. Clone or Download the Repository
    * Start by cloning this repository (``` console git clone https://github.com/prasanthse/digital-portfolio.git```) to your local machine using Git, or download the ZIP file and extract it.
...
7. Initialize a Git Repository with ```console git init```.
8. Install Project Dependencies (Only for the first time)
    * Install all required dependencies by running ```console npm install``` in your code editor's terminal.
9. Start the Development Server
    * Once the installation is complete, start the development server using ```console npm run start```.
10. You're All Set🎉!
...
2. Set your remote origin via ```console git remote add origin https://github.com/<your-username>/<your-repo>.git```. (Only for the first time)
